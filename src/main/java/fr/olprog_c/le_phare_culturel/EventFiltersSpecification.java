...
public class EventFiltersSpecification {
    ...
    /**
     * This method generates a Specification for a CriteriaQuery to filter EventEntities by the phoneBrand and phoneName columns.
     *
    ...
    /**
     * This method generates a Specification for a CriteriaQuery to filter EventEntities by various columns.
     * The columns to filter by are determined by the keys of the filters Map.
     *
     * @param filters a Map where keys are the columns to filter by, and values are the keywords used for the filtering
     * @return a Specification for a CriteriaQuery
     */
