...
public final class RouteDefinition {
  ...
  public static class Auth {
    ...
    public static final String AUTH_STATUS_URL = AUTH_URL + "/status";
    public static final String REFRESH_TOKEN_URL = AUTH_URL + "/token/refresh";
  }
  ...
  public static class Events {
    ...
    public static final String EVENTS_WITH_ID_GROUP_WITH_ID_URL = EVENTS_URL + "/{eventid}/"
