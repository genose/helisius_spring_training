...
abstract public class BaseRoutesController {
	...
	/* ****** ****** ****** ****** */
	// TODO: Discuter d'une amélioration
	@RequestMapping(value = "", method = {RequestMethod.PATCH, RequestMethod.PUT, RequestMethod.POST})
	...
	public ResponseEntity<Object> deleteEntityByID(@PathVariable int id, @RequestParam Map<String, String> allParams) {
		...
		return ResponseEntity.unprocessableEntity().body("From Class : Base::" + this.getClass().getSimpleName() + " :: "
				+ GNSClassStackUtils.getEnclosingMethodObject(this));
	}

	/* ****** ****** ****** ****** */
	@GetMapping("/hello")
	// .... @ApiOperation(value = "Hello World", notes = "Returns a greeting
	// message")
	public String hello() {
		return "Hello, World!";
	}
	...
	public ResponseEntity<Object> handleException(Exception e) {
		...
		String loggerMessageFormatted = String.format("Exception occurred in [%s] %s : %s ", className, methodName,
				message);
